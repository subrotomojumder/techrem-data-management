...
export const SmallSpinner = () => {
    return (
        <div className='mx-auto animate-spin border-t-4 border-t-green-400 border-r-4 border-r-green-400  border-b-4 border-b-green-400 border-l-4 border-l-white rounded-full w-5 h-5 inline-block'>
           {/* jfksajfkl  */}
        </div>
    );
};
