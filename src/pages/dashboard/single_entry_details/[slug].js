...
const Single_Entry_show = () => {
    ...
    if (data?.success) {
        const { businessDetails: { businessName, category, businessSize, businessLogo, images }, onProcess, tag, other_information, have_branchs: { branch_detalis }, createdAt, updatedAt, address: { country, state, city, street_address, postCode }, have_website: { website_urls }, ownerDetails: { name, email, phone, country_code } } = data.data;
        return (
