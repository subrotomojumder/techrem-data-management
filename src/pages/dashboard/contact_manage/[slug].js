...
const Contact_manage = () => {
    ...
    const [taskPost, { isLoading }] = usePostOperatorTaskSubmitMutation();
    ...
    const handleUpdate = (e) => {
        ...
        if (inputData?._id) {
            updateTaskSubmission({ url: `/operator_data/teleOperator/${inputData?._id}`, updateData: data })
                .then(res => {
                    console.log(res);
                    if (res.data?.success) {
            ...
            taskPost({ url: "/operator_data/teleOperator", data })
                .then(res => {
                    console.log(res);
                    if (res.data?.success) {
