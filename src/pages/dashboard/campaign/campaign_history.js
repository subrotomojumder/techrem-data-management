...
const Campaign_history = () => {
    ...
    return (
        <div className='w-full max-w-[1300px] mx-auto mdd:px-8'>
            <div className="px-2 smm:px-6 mdd:px-6 xl:px-8 py-4 sm:py-6 xl:py-6 my-2 smm:my-6 bg-white shadow-sm rounded-lg min-h-screen">
                <div className='flex justify-between items-center px-2 md:px-4 mb-1'>
                    <h2 className="text-xl md:text-2xl  font-medium smm:font-semibold leading-5 lg:leading-10 text-gray-900">History of Campaign</h2>
            ...
            <PaginationBar totalDataLength={40} stockLimit={stockLimit} setStockLimit={setStockLimit} currentPage={currentPage} setCurrentPage={setCurrentPage}></PaginationBar>
        </div>
    );
};
